...
| --- | --- | --- |
| Direct gold accumulation first entry | Open | Gold target remains unfilled even after the Zijin add. |
| Li Auto review | Open | It remains the biggest unrealized loss and weakest current role. |
| Weekly investment committee record | Open | The recurring operating rhythm still needs the first live weekly record. |
| Post-add Zijin review | Open | The first executed add needs follow-up against the new trigger set. |
