...
管理新增资金。
目标：创造新的绝对收益。
核心能力：选择趋势向上 + 高波动 + 高催化的股票，并通过做T放大收益。

第二增长引擎见 trade_playbook/第二增长引擎候选池_v0.2

### 第一笔正式实践

2026-07-23 腾讯控股（0700.HK） 446.2港元 买入100股。

这是 Rachel Capital 第二增长引擎的第一笔正式建仓，标志着组合开始由单一的存量资产修复（Recovery Engine）扩展为「Recovery Engine + Growth Engine」双引擎模式。

Growth Engine 的目标不是长期持有，而是在保证中长期上涨趋势的前提下，通过较大的波动率持续进行做T，提高资金利用效率和组合收益率。
